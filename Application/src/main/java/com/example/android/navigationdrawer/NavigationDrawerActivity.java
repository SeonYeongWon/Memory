...
public class NavigationDrawerActivity extends Activity implements PlanetAdapter.OnItemClickListener, View.OnClickListener {
    ...
    public static class PlanetFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(i==0){
                rootView = inflater.inflate(R.layout.family_layout, container, false);
            }
            else if(i==1){
                rootView = inflater.inflate(R.layout.friend_layout, container, false);
            }else if(i==2){
                rootView = inflater.inflate(R.layout.teacher_layout, container, false);

            }

            iv=((ImageView) rootView.findViewById(R.id.family));
